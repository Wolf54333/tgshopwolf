...
main_menu.add(types.InlineKeyboardButton(text='👩🏻‍💻 Тех. Поддержка', url='https://t.me/ua_BarZ_ua'))
...
adm_main_menu.add(types.InlineKeyboardButton(text='👩🏻‍💻 Тех. Поддержка', url='https://t.me/ua_BarZ_ua'))
...
kur_main_menu.add(types.InlineKeyboardButton(text='👩🏻‍💻 Тех. Поддержка', url='https://t.me/ua_BarZ_ua'))
kur_main_menu.add(types.InlineKeyboardButton(text='🔹 Реферальная система', callback_data='ref_system'))
kur_main_menu.add(
    types.InlineKeyboardButton(text='📊 Статистика', callback_data='stat'),
    types.InlineKeyboardButton(text='😈 Меню Воркера', callback_data='exit_to_kur_menu')
)
...
users_config.add(
    ...
    types.InlineKeyboardButton(text='🔓 Выдать Воркера', callback_data='add_kur'),
    types.InlineKeyboardButton(text='🔒 Забрать Воркера', callback_data='remove_kur')
)
